...
<body>
  ...
  <section id="header">
    <div class="header container">
      <div class="nav-bar">
        <div class="brand">
          <a href="#hero"><h1><span>A</span>ssist <span>M</span>e</h1></a>
        </div>
        <div class="nav-list">
          ...
          <ul>
            ...
            <li><a href="feedback1.php">Support&Feedback</a></li>
  ...
  <section id="services">
    <div class="services container">
      <div class="service-top">
        ...
        <p><a href="login.php"> Login to Begin </a></p>
      </div>
    </div>
  </section>
  <!-- End Service Section -->
    ...
    <div class="about container">
     <h1 class="section-title">About <span>Us</span></h1>
      ...
      <div class="col-right"> 
        ...
        <a href="Sample_Resume_bv.pdf" class="cta" downolad>Download Resume</a>
      </div>
      <div class="col-left">
        <div class="about-img">
      ...
      <div class="col-right">
        ...
        <p>CP with cpp</p>
        <a href="Sample_Resume_kcm.pdf" downolad class="cta">Download Resume</a>
      </div>
</div>
  </section>
  <!-- End About Section -->
